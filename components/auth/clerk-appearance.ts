...
export function getClerkAppearance(isDark: boolean): Appearance {
  return {
    ...
    variables: {
      colorPrimary: isDark ? "#b4c5ff" : "#4338ca",
    ...
    elements: {
      ...
      formFieldInput: isDark
        ...
        : "border border-slate-200 bg-slate-50 text-[#0b1120] placeholder:text-slate-400 focus:border-[#4338ca]/50 rounded-lg",
      formButtonPrimary: isDark
        ? "bg-[#b4c5ff] text-[#00389a] hover:bg-[#c5d3ff] font-semibold rounded-lg transition-colors"
        : "bg-[#4338ca] text-white hover:bg-[#3730a3] font-semibold rounded-lg transition-colors",
      footerActionLink: isDark
        ? "text-[#b4c5ff] hover:text-[#dfe4ff] font-medium"
        : "text-[#4338ca] hover:text-[#3730a3] font-medium",
      ...
      identityPreviewEditButton: isDark ? "text-[#b4c5ff]" : "text-[#4338ca]",
    },
  };
}
